const locator = {
    ...
    partitions: {
        checkBoxSelectA: `[id="adminListsParitionGrid-body"] [data-recordindex="2"] [role="row"] [tabindex="-1"]`,
        checkBoxSelectB: `[id="adminListsParitionGrid-body"] [data-recordindex="3"] [role="row"] [tabindex="-1"]`,
        checkBoxSelectC: `[id="adminListsParitionGrid-body"] [data-recordindex="4"] [role="row"] [tabindex="-1"]`,
    },
