...
const { FeatureStatesTypeData } = require('../../../../components/administration/Agile/featureStates_page.component');
...
// Lists Categories
When(`I select Administration and select Agile`, timeout, async function () {
    let page = this.page;
