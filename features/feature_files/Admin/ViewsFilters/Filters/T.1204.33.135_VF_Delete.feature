Feature: Pdware Admin User Module
    ...
    @delete @668 @T.1204.33.135
    Scenario: @T.1204.33.135-testing user data
        When I select Administration and select Views & Filters and select Filters
        When I select Financial from the dropdown menu

        Then I delete names in the Filters Data
        Then I delete names in the Filters Data B
        Then I delete names in the Filters Data C
