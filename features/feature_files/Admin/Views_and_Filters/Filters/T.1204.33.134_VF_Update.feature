Feature: Pdware Admin User Module
    ...
    @update @668 @T.1204.33.134
    Scenario: @T.1204.33.134-testing user data
        When I select Administration and select Views & Filters and select Filters
        When I select Financial from the dropdown menu

        Then I re-type names in the Filters Data
        Then I re-type names in the Filters Data B
        Then I re-type names in the Filters Data C
