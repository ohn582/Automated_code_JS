Feature: Pdware Admin User Module
    ...
    @create @668 @T.8410.23.001
    Scenario: @T.8410.23.001-testing user data
        When I select Administration and select List
        When I select User Defined Lists
        Then I select ULDRescource

        When I select Add Button in the ULDRescource
        Then I typed a new ULDRescource Field 33


        When I clicked add button in Defined List Details
        Then I Re-type Rescource tes1
